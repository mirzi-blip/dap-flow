...
export const DEFAULT_FORM_OPTIONS: RawOption[] = [
  ...
  // ── Graphics — Project Categories ────────────────────────────────────────────
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Banners',                        'Banners',                        0),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Flag Type',                      'Flag Type',                      1),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Billboards',                     'Billboards',                     2),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Vehicle wraps',                  'Vehicle wraps',                  3),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Wall murals',                    'Wall murals',                    4),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Window graphics',                'Window graphics',                5),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Boundary Signages',              'Boundary Signages',              6),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Lighted Signage',                'Lighted Signage',                7),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Wallsigns',                      'Wallsigns',                      8),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Signages',                       'Signages',                       9),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Backdrops',                      'Backdrops',                      10),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Roll-up banners',                'Roll-up banners',                11),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Floor graphics',                 'Floor graphics',                 12),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Event displays',                 'Event displays',                 13),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Trade show booths',              'Trade show booths',              14),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Brochures',                      'Brochures',                      15),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Flyers',                         'Flyers',                         16),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Leaflets',                       'Leaflets',                       17),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Catalogs',                       'Catalogs',                       18),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Magazines',                      'Magazines',                      19),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Books',                          'Books',                          20),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Calendars',                      'Calendars',                      21),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Packaging boxes',                'Packaging boxes',                22),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Paper bags',                     'Paper bags',                     23),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Corporate stationery',           'Corporate stationery',           24),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Envelopes',                      'Envelopes',                      25),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Notebooks',                      'Notebooks',                      26),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Bundling Sticker',               'Bundling Sticker',               27),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Wobbler',                        'Wobbler',                        28),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Shelftalker',                    'Shelftalker',                    29),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Product Sticker',                'Product Sticker',                30),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'PR Box',                         'PR Box',                         31),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Price Tag',                      'Price Tag',                      32),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Neck tag',                       'Neck tag',                       33),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Customized T-shirts and sportswear', 'Customized T-shirts and sportswear', 34),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Coffee mugs and drinkware',      'Coffee mugs and drinkware',      35),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Lanyards',                       'Lanyards',                       36),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Cap and Arm Sleeves',            'Cap and Arm Sleeves',            37),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Umbrella',                       'Umbrella',                       38),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Folded Round Fan',               'Folded Round Fan',               39),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Eco Bag',                        'Eco Bag',                        40),
  S('Graphics', 'dsw_paperSize', 'Project Category', 'Loot Bag',                       'Loot Bag',                       41),

  // ── Graphics — Printing Processes ────────────────────────────────────────────
  S('Graphics', 'dsw_colorMode', 'Printing Process', 'Large Format Printing', 'Large Format Printing', 0),
  S('Graphics', 'dsw_colorMode', 'Printing Process', 'Offset Lithography',    'Offset Lithography',    1),
  S('Graphics', 'dsw_colorMode', 'Printing Process', 'Sublimation Printing',  'Sublimation Printing',  2),
  ...
  // ── Graphics — Materials by Printing Process ─────────────────────────────────
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'HDPE Tarpaulin',           'HDPE Tarpaulin',           0),
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'LDPE Tarpaulin',           'LDPE Tarpaulin',           1),
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'Multi Layer Tarpaulin',    'Multi Layer Tarpaulin',    2),
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'Cross Laminated Tarpaulin','Cross Laminated Tarpaulin',3),
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'PVC Coated Tarpaulin',     'PVC Coated Tarpaulin',     4),
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'Cotton Canvas Tarpaulin',  'Cotton Canvas Tarpaulin',  5),
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'Vinyl stickers',           'Vinyl stickers',           6),
  S('Graphics-Large Format Printing', 'dsw_material', 'Material Type', 'Sintra (PVC board)',        'Sintra (PVC board)',        7),

  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Bond Paper',         'Bond Paper',         0),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Onion Skin',         'Onion Skin',         1),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Carbonless Paper',   'Carbonless Paper',   2),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Bookpaper',          'Bookpaper',          3),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'C1S coated',         'C1S coated',         4),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Matte coated',       'Matte coated',       5),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'C2S coated',         'C2S coated',         6),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Foldcote',           'Foldcote',           7),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Claycoated Board',   'Claycoated Board',   8),
  S('Graphics-Offset Lithography', 'dsw_material', 'Material Type', 'Carrier Board',      'Carrier Board',      9),

  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Polyester Fabric',                  'Polyester Fabric',                  0),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Polyester T-shirt',                 'Polyester T-shirt',                 1),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Sports Jersey Fabric',              'Sports Jersey Fabric',              2),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Satin Fabric',                      'Satin Fabric',                      3),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Microfiber Fabric',                 'Microfiber Fabric',                 4),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Canvas (Polyester)',                'Canvas (Polyester)',                5),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Ceramic Mug (Sublimation Coated)',  'Ceramic Mug (Sublimation Coated)',  6),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Metal Sheet (Sublimation Coated)',  'Metal Sheet (Sublimation Coated)',  7),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Aluminum Plate (Sublimation Coated)','Aluminum Plate (Sublimation Coated)',8),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'MDF Wood (Sublimation Coated)',     'MDF Wood (Sublimation Coated)',     9),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Acrylic (Sublimation Coated)',      'Acrylic (Sublimation Coated)',      10),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Glass (Sublimation Coated)',        'Glass (Sublimation Coated)',        11),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Mouse Pad',                         'Mouse Pad',                         12),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Puzzle Board',                      'Puzzle Board',                      13),
  S('Graphics-Sublimation Printing', 'dsw_material', 'Material Type', 'Lanyard',                           'Lanyard',                           14),
